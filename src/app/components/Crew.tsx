...
const C = { cream: "#F8F8F8", ink: "#0B0B0B", bone: "#F2F2F2", red: "#E2231A" };
...
export function Crew({ onSelect }: Props) {
  return (
    <div
      className="min-h-screen px-6 lg:px-12 py-6 lg:py-8"
      style={{
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span
              ...
              style={{ ...mono, backgroundColor: C.red, color: C.bone }}
            >
              ROSTER // 10
            </span>
          ...
          <h1
            className="text-6xl sm:text-7xl lg:text-8xl leading-[0.85] uppercase"
            style={display}
          >
            <span className="block">Straw Hat</span>
            <span
              className="block"
              style={{ color: C.red, textShadow: `4px 4px 0 ${C.ink}` }}
            >
              Pirates
            </span>
          </h1>
          <div
            className="text-xl lg:text-2xl mt-1"
            style={{ ...jp, fontWeight: 900 }}
          >
            麦わらの一味
          </div>
        </div>
          ...
          >
            ...
            <div className="p-3 lg:p-4">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[10px] tracking-[0.2em]" style={mono}>
                  {m.role.toUpperCase()}
                </span>
                <ArrowUpRight className="w-4 h-4 opacity-60 group-hover:opacity-100 transition" />
              </div>
              <div
                className="text-xl lg:text-2xl leading-none uppercase"
                style={display}
              >
                {m.alias}
              </div>
              ...
              <div
                ...
                style={{ backgroundColor: C.ink, opacity: 0.2 }}
              />
              <div
